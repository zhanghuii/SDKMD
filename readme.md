...
md5("channel_pkg_num=88001&time=1498878255&token=ddh24e23cdscjwe8fdse328rs&" + {app_key}),其中+时连接符
  ...
  | 参数名   |      参数规格      | 必填   |      说明      |
   ...
   | 地址类型   |      地址      |
   |----------|:-------------:|
   | 正式地址 |  由我方后台配置或CP客户端传入SDK客户端，优先我方后台配置<br/>通知地址必须以http(s)://开头<br/>正确示例：http(s)://www.XXX.com/recharge <br/>错误示例：www.XXX.com/recharge<br/><font color=#D2691E>注：回调地址中不能存在&符号</font> |
